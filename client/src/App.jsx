        ...
        >
          ...
          >
            <div>
              ...
              >
                Le flux video vient maintenant du navigateur. Si le backend
                temps reel ne repond pas, le frontend reste vivant avec une
                simulation locale pour tester l'overlay et l'historique.
              </p>
            </div>
              ...
              <div>
                ...
                {detections.length === 0 ? (
                  <p style={{ margin: 0, color: "#7A6245", lineHeight: 1.55 }}>
                    Aucune detection recue pour l'instant. Le panneau se
                    remplira des que le socket ou la simulation enverra des
                    donnees.
                  </p>
                ) : (
                  <div
